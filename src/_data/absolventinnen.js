...
let absolventinnen = [
	...
	{
		"slug": "leanaumann",
		"desc_short": "Konzept und Gestaltung eines fiktiven Events für den DHB (Deutscher Hockey-Bund)",
		"desc_long": "Ich spiele Hockey. Nein, kein Eishockey mit Schlittschuhen und Puck. Die Unbekanntheit des klassischen Feldhockeys verwundert mich schon lange, da es die erfolgreichste Ballsportart Deutschlands ist und wir traditionell zu den erfolgreichsten Hockey-Nationen der Welt zählen. Um der Sportart zu mehr Aufmerksamkeit zu verhelfen habe ich das erste Hockeyevent konzipiert, welches sich nicht exklusiv an die Hockeygemeinschaft richtet, sondern die Öffentlichkeit als Zielgruppe anspricht.",
		"name": "Lea Naumann",
	...
	},
	{
		...
		"desc_long": "Kleidung trägt in unserer Gesellschaft einen maßgeblichen Teil zur individuellen Selbstdarstellung bei und ist auch für uns, die Geschwister Heiter, ein gern genutztes kreatives Mittel zum Selbstausdruck. Deshalb haben wir eine Corporate Identity für unsere bisher fiktive Vintage-, Second-hand- & Upcycling-Modemarke Heiter Weiter entwickelt und gestaltet. Langfristig profitieren wir alle davon, wenn wir den übertrieben Wegwerfkonsum, den die schnelllebige Modeindustrie vorgibt, in seine Schranken weisen und stattdessen unsere Schränke mit einzigartigen Schätzen aufwerten.\n Look good - Do good.",
